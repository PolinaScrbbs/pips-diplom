...
def run():
    ...
    for u_data in users_info:
        u, created = User.objects.get_or_create(
            username=u_data["username"], defaults=u_data
        )
        if created:
            u.set_password("1")
            u.save()
    ...
    reviews_content = [
        (
            "Замечательный логопед! Ребенок начал выговаривать 'Р' уже через месяц.",
            "Мама",
            "Логопед-дефектолог",
            5,
        ),
        (
            "Прошли диагностику, получили четкий план действий. Очень профессионально.",
            "Папа",
            "Первичная диагностика",
            5,
        ),
        (
            "Дочке очень нравятся занятия арт-терапией, стала намного спокойнее.",
            "Мама",
            "Арт-терапия",
            4,
        ),
        (
            "Сенсорная интеграция — это спасение для нашего гиперактивного сына.",
            "Отец",
            "Сенсорная интеграция",
            5,
        ),
        (
            "Хороший центр, но иногда сложно записаться на удобное время.",
            "Мама",
            "Детский психолог",
            3,
        ),
        (
            "Ходим на подготовку к школе, очень сильная программа.",
            "Бабушка",
            "Подготовка к школе",
            5,
        ),
        (
            "Логопед нашел подход к самому капризному ребенку. Рекомендую!",
            "Мама",
            "Логопед-дефектолог",
            5,
        ),
        (
            "Результаты диагностики совпали с нашими наблюдениями на 100%.",
            "Папа",
            "Первичная диагностика",
            4,
        ),
    ...
    print(
        f"✅ База обновлена: {Booking.objects.count()} бронирований и {Review.objects.count()} отзывов."
    )
