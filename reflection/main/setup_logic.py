...
def run():
    ...
    services_data = [
        {'name': 'Первичная диагностика', 'price': 2500, 'duration': '60 мин', 'short_description': 'Комплексное обследование нейропсихолога.'},
        {'name': 'Логопед-дефектолог', 'price': 1500, 'duration': '45 мин', 'short_description': 'Коррекция звукопроизношения и развитие речи.'},
        {'name': 'Детский психолог', 'price': 2000, 'duration': '50 мин', 'short_description': 'Эмоциональная поддержка и работа с поведением.'},
        {'name': 'Сенсорная интеграция', 'price': 1800, 'duration': '45 мин', 'short_description': 'Занятия в специально оборудованном зале.'},
        {'name': 'Подготовка к школе', 'price': 1200, 'duration': '60 мин', 'short_description': 'Групповые занятия для будущих первоклассников.'},
        {'name': 'Арт-терапия', 'price': 1400, 'duration': '90 мин', 'short_description': 'Творческое самовыражение и снятие зажимов.'},
    ]
